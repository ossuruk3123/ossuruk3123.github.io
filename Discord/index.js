...
const socket = io('testrendersitesxd.onrender.com', { // insert API Link
...
const discordIds = {
	guild: '1378729139225362542', // Discord Guild ID
	mmChannel: '1395008434855743600', // Channel to send Middleman Open Message
	clientRole: '1386989877618282567', // Role given to the client
}
...
client.login('MTM4MzczOTAwNzczMjU1MTcxMA.GTBCL6.Ls4rrhfNXgsXPB3L1z9-Sfk09t92e6CNyBJl_I'); // discordToken

client.once(Events.ClientReady, async c => {
	console.log(`Discord Client Ready! Logged in as ${c.user.tag}`);
	client.mmGuild = client.guilds.cache.get(discordIds.guild);

	await mongoose.connect('mongodb+srv://myuser:terbisil1@bottest.jvb7ir9.mongodb.net/?retryWrites=true&w=majority&appName=BotTest'); // mongoKey
